...
const devSystemCn = {
  devSystem: {
    ...
    imageMgmt: {
      ...
      errorMessage: '错误信息',
      startMethod: '启动方式',
      sysdiskInfo: '使用该镜像创建虚拟机时，对于虚拟机系统磁盘大小的最低要求，即不小于制作镜像时使用的虚拟机磁盘。',
      typeValue: {
        public: '公共',
        private: '私有',
        isPublic: '是否公开'
      ...
      tip: {
        ...
        editImg: '修改系统镜像',
        viewImg: '查看系统镜像详情',
        nameRule: '长度4-128，只能包含英文、数字、_、-，开头结尾不能为_、-',
        ...
        sysImageFileType: '请上传格式为qcow2或iso，并且大小不超过100G的文件！',
        ...
        nameEmpty: '名称不能为空！',
        downloadInfo: '为提升下载效率，请复制下面的链接到空白页签进行下载'
      }
    },
    capability: {
      systemMep: '能力中心管理',
    ...
    promptMessage: {
      ...
      textWrap: '只能包含中英文、空格、/，首尾不能有空格',
      systemCapaNameCn: '请输入长度1-40的中文名称，开头不能为空',
      systemCapaNameEn: '请输入长度1-40的其他语言，开头不能为空',
      systemCapaDescCn: '请输入长度1-400的中文描述，开头不能为空',
      systemCapaDescEn: '请输入长度1-400的其他语言，开头不能为空',
      systemServiceName: '请输入长度1-40的服务名称，开头不能为空',
      systemProviderName: '请输入长度1-30的供应商名称',
      systemDocument: '请上传中文说明文档',
      systemDocumentEn: '请上传其他语言文档',
      uploadApiFile: 'API定义文件',
      fileNameType: '文件名称不能包含空格！',
      moreThan2: '只能上传不超过2MB的文件！',
      checkFileType: '请上传符合格式的文件',
      onlyOneFile: '仅支持一个文件，请先移除已有文件！',
      hostFormatInfo: '资源配置或者网络配置格式有误，格式必须为键值对，并且以;分开',
      hostNetworkConfigInfo: '网络配置内容有误，未包含相关网络配置',
      cannotBeEmpty: '开头不能为空'
    }
  }
}
