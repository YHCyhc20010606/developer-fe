...
const appCn = {
  incubation: {
    ...
    nameTip: '请输入应用名称',
    nameRule: '不含空格，长度4-32，不能全为数字，只能包含数字、字母、汉字、_、-，开头结尾不能为_、-',
    nameRuleClab: '不含空格和汉字，长度4-32，不能全为数字，只能包含数字、字母、_、-，开头结尾不能为_、-',
    lengthTip: '长度在 3 到 15 个字符',
    versionTip: '请输入应用版本',
    versionRule: '长度1-20，数字、字母、_、-开头，不能包含空格',
    providerTip: '请输入应用开发商',
    providerRule: '长度1-30，不能包含空格',
    providerRuleClab: '长度1-30，不能包含空格和汉字',
    descTip: '请输入应用描述',
    descriptionRule: '长度1-1024，开头不能为空，不能全为数字',
    descriptionRuleClab: '长度1-1024，开头不能为空，不能全为数字，不能包含汉字',
    container: '容器',
    vm: '虚拟机',
