...
const devSystemEn = {
  devSystem: {
    ...
    imageMgmt: {
      ...
      sysdiskInfo: 'When using this image to create a virtual machine, the minimum size of the virtual machine system disk is not smaller than the virtual machine disk used when creating the image.',
      typeValue: {
        public: 'Public',
        private: 'Private',
      ...
      tip: {
        ...
        nameRule: 'Length 4-128, can only contain English, numbers, _, -, the beginning and end cannot be _, -',
        ...
        sysImageFileType: 'Please upload the file in the format of qcow2 or iso, and the size does not exceed 100G!',
        ...
        deleteImgSuccess: 'The system image is deleted successfully!',
        ...
        downloadInfo: 'In order to improve the download efficiency, please copy the link below to a blank tab to download'
      }
    },
    capability: {
      ...
      guideFileId_other: 'Guide(other languages)',
      zh_cn: 'please input chinese',
      en: 'please input english',
      other: 'please input other languages',
      portRange: 'Port Range',
      config_id: 'Config File',
      networkConfig: 'Network Config',
      configParamas: 'Configuration parameters',
    ...
    promptMessage: {
      ...
      textWrap: 'Can only contain Chinese and English, spaces, /, no spaces at the beginning and end',
      systemCapaNameCn: 'Please enter a Chinese name with a length of 1-40, the beginning cannot be empty',
      systemCapaNameEn: 'Please enter other languages with a length of 1-40. The beginning cannot be empty',
      systemCapaDescCn: 'Please enter a Chinese description with a length of 1-400, the beginning cannot be empty',
      systemCapaDescEn: 'Please enter other languages with a length of 1-400, the beginning cannot be empty',
      systemServiceName: 'Please enter a service name with a length of 1-40, the beginning cannot be empty',
      systemProviderName: 'Please enter a provider name with a length of 1-30',
      systemDocument: 'Please upload Chinese documentation',
      systemDocumentEn: 'Please upload documents in other languages',
      ...
      hostFormatInfo: 'The resource configuration or network configuration format is incorrect. The format must be a key-value pair and separated by ;',
      hostNetworkConfigInfo: 'The content of the network configuration is incorrect, and the relevant network configuration is not included',
      cannotBeEmpty: 'The beginning cannot be empty'
    }
  }
}
