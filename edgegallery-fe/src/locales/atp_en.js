...
const atpEn = {
  ...
  atpTestProcess: {
    ...
    publishInfo: 'The test is successful, click the publish button to publish the app to the Appstore',
    capabilityIsExist: 'Application release succeeds, service release fails (the included service already exists)'
  }
}
