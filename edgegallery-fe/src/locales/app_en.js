...
const appEn = {
  incubation: {
    ...
    nameRule: 'No spaces, length 4-32, cannot be all numbers, can only contain numbers, letters, Chinese characters, _, -, and cannot start and end with _,-',
    nameRuleClab: 'Does not contain spaces and Chinese characters, length 4-32, cannot be all numbers, can only contain numbers, letters, _, -, cannot start and end with _, -',
    lengthTip: 'The app name should be including 3-15 letters.',
    versionTip: 'Please enter the app version.',
    versionRule: 'Length 1-20, start with numbers, letters, _, -, cannot contain spaces',
    providerTip: 'Please enter the app provider.',
    providerRule: 'Length 1-30, cannot contain spaces',
    providerRuleClab: 'Length 1-30, cannot contain spaces and Chinese characters',
    ...
    descriptionRuleClab: 'Length 1-1024, the beginning cannot be empty, and cannot be all numbers, cannot contain Chinese characters',
    container: 'Container',
    vm: 'VM',
  ...
  toolBox: {
    ...
    appEditor: {
      ...
      hasTab: 'The file cannot contain the Tab key'
    },
    appIsExist: 'The same application already exists'
  }
}
