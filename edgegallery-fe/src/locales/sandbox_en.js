...
const sandboxEn = {
  sandbox: {
    antiAffinityInfo: 'Anti-affinity group information',
    ...
    hostGroupTip: 'Please enter the host group name',
    isImageEmpty: 'Please select image',
    isFlavorEmpty: 'Please select the VM flavor',
    ...
    flavorFilterInfo: 'Note: The data displayed in the table has been filtered according to the size of the system disk required to select the image',
    flavorIsExist: 'A VM Flavor with the same name already exists'
  },
  rulesConfig: {
    ...
    filterRulesisEmpty: 'The flow filter rule cannot be empty, please add a flow filter'
  },
  container: {
    script: 'Script',
    import: 'Import',
  ...
  sandboxPromptInfomation: {
    ...
    nameRule: 'Length 4-15 can only contain English, numbers, _, -, the beginning and end cannot be _, -',
    nameInfoError: 'Please fill in the vm name according to the rules',
    selectSandboxFirst: 'Please select a sandbox first!',
    waitSSH: 'SSH is connecting, please wait...',
    deleteInternetPrompt: 'The default network configuration cannot be recovered after deleted!',
    exportImagePrompt: 'It takes a long time to generate an image, please be patient',
    deleteVmInfo: 'The virtual machine is used by an anti-affinity group and cannot be deleted!',
    nameEmpty: 'Please enter a name',
    descEmpty: 'Please enter a description',
    creatFail: 'Failed to create',
    updateFail: 'update failed',
    vmEmpty: 'Please select a virtual machine'
  }
}
