...
function getRouterComponent (routerPath) {
  ...
  } else if (routerPath.startsWith(NAV_PRE.APPSTORE) || routerPath.startsWith(NAV_PRE.MECM) || routerPath.startsWith(NAV_PRE.ATP)) {
    return () => import('../pages/Container.vue')
  // [移除] 2026-01-05 移除System路由判断
...
export default new Router({
  routes: [
    ...
    // [移除] 2026-01-05 注释掉所有Developer相关路由
    {
    ...
    {
      path: '/EG/developer/platform/mep',
      name: 'capabilities',
      component: () => import('../pages/developer/platformCapability/AbilityHome.vue')
    },
    {
      path: '/EG/developer/platform/mep/serviceDoc',
      name: 'serviceDoc',
      component: () => import('../pages/developer/platformCapability/ServiceDoc.vue')
    },
    {
      path: '/EG/developer/platform/mep/apiAmulator',
      name: 'apiAmulator',
      component: () => import('../pages/developer/platformCapability/ApiAmulator.vue')
    },
    {
      path: '/EG/developer/toolbox/appedit',
      name: 'appedit',
      component: () => import('../pages/developer/toolBox/applicationEditor/Index.vue')
    },
    {
      path: '/EG/developer/mecDeveloper/docs',
      name: 'docs',
      component: () => import('../pages/developer/document/Document.vue')
    },
    {
    ...
    */
    {
      path: '/appStore/home/detail',
      name: 'appstoreDetail',
      component: () => import('../pages/Container.vue')
    },
    {
      path: '/appStore/home/appShare',
      name: 'appstoreAppShare',
      component: () => import('../pages/Container.vue')
    },
    {
      path: '/appStore/home/appChange',
      name: 'appChange',
      component: () => import('../pages/Container.vue')
    },
    {
      path: '/appStore/home/app/test/task',
      name: 'appStoreTask',
      component: () => import('../pages/Container.vue')
    },
    {
      path: '/appStore/home/senceDetail',
      name: 'appStoreSenceDetail',
      component: () => import('../pages/Container.vue')
    },
    {
      path: '/appStore/home/selectscene',
      name: 'appStoreSelectscene',
      component: () => import('../pages/Container.vue')
    },
    {
      path: '/mecm/mecm/app/distribution',
      name: 'mecmDistribution',
      component: () => import('../pages/Container.vue')
    },
    {
      path: '/mecm/mecm/app/ruleconfig',
      name: 'mecmRuleconfig',
      component: () => import('../pages/Container.vue')
    },
    {
      path: '/mecm/mecm/app/package',
      redirect: '/mecm/mecm/app/deploy'
    },
    {
      path: '/mecm/mecm/app/instance',
      redirect: '/mecm/mecm/app/deploy'
    },
    ...routes
  ]
