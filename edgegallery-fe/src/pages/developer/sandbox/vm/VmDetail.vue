    ...
    >
      ...
      <div class="vm-content">
        ...
        <p class="clear">
          ...
          <span
            v-if="(vmImageInformation.downloadUrl==='' || vmImageInformation.downloadUrl===null)"
          >
            {{ 'NA' }}
          </span>
          <span
            ...
            class="download-info"
          >
            {{ $t('devSystem.imageMgmt.tip.downloadInfo') }}
          </span>
          <span
            class="content-right download-url lt"
            v-if="(vmImageInformation.downloadUrl!=='' && vmImageInformation.downloadUrl!==null)"
          >
...
export default {
  ...
  methods: {
    ...
    downloadExportImage () {
      return sandbox.downloadExportImage(this.applicationId, this.vmId)
    },
    getVmDetail (vmId) {
