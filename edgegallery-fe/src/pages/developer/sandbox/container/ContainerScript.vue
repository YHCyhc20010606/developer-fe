...
export default {
  ...
  methods: {
    ...
    jumpToImageList () {
      let _imageListHref = this.$router.resolve({ path: 'system/imagemgmt' })
  ...
  .config-file{
    ...
    .package{
      ...
      .file-content::-webkit-scrollbar-thumb{
        background: rgba(153,133,208,0.8);
      }
      .v-note-wrapper .v-note-panel .v-note-edit.divarea-wrapper.single-edit::-webkit-scrollbar{
        width: 8px;
        height: 10px;
        border-radius: 10px;
      }
