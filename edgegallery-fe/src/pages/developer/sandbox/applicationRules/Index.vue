...
<template>
  <div class="application-rules">
    ...
    >
      ...
      <!-- 隐藏流量规则区，仅保留 DNS；DNS 标题与表格上移至原流量规则位置（集成开发/沙箱 UPF，2026-05-16） -->
      <!--
    ...
    <!-- 流量规则编辑子面板（含过滤器/接口）已隐藏，与上方列表一致（2026-05-16） -->
    <!--
    <trafficRules
      class="traffic-rules"
...
<script>
// import trafficRules from './AddTrafficRules.vue' // 隐藏流量规则（2026-05-16）
