  ...
  methods: {
    ...
    loadingUploadByProgress (_isCn, circleX, circleY, ctx) {
      if (_isCn) {
        ...
        this.loadImage(circleX + 15, circleY / 6 + 18, ctx, this.pkgInstatiateTip)
        this.loadImage(circleX + 190, circleY + 63, ctx, this.pkgGetStatusTip)
      } else {
        this.loadImage(circleX / 3 - 25, circleY + 65, ctx, this.pkgUploadingTipEn)
        this.loadImage(circleX + 15, circleY / 6 + 18, ctx, this.pkgInstatiateTipEn)
        this.loadImage(circleX + 190, circleY + 63, ctx, this.pkgGetStatusTipEn)
      }
    ...
    loadingInstatiateByProgress (_isCn, circleX, circleY, ctx) {
      if (_isCn) {
        ...
        this.loadImage(circleX / 3 - 25, circleY + 65, ctx, this.pkgUploadingEndTipEn)
        this.loadImage(circleX + 15, circleY / 6 + 18, ctx, this.pkgInstatiateTipEn)
        this.loadImage(circleX + 190, circleY + 63, ctx, this.pkgGetStatusTipEn)
      }
    ...
    loadingGetStatusByProgress (_isCn, circleX, circleY, ctx) {
      if (_isCn) {
        this.loadImage(circleX / 3 - 10, circleY + 65, ctx, this.pkgUploadingEndTip)
        this.loadImage(circleX + 15, circleY / 6 + 18, ctx, this.pkgInstatiateEndTip)
        this.loadImage(circleX + 190, circleY + 63, ctx, this.pkgGetStatusTip)
      } else {
        this.loadImage(circleX / 3 - 25, circleY + 65, ctx, this.pkgUploadingEndTipEn)
        this.loadImage(circleX + 15, circleY / 6 + 18, ctx, this.pkgInstatiateEndTipEn)
        this.loadImage(circleX + 190, circleY + 63, ctx, this.pkgGetStatusTipEn)
      }
      this.loadImage(circleX - 190, circleY + 50, ctx, this.showEnd)
    ...
    loadCommonTip (_isCn, circleX, circleY, ctx) {
      if (_isCn) {
        this.loadImage(circleX / 3 - 10, circleY + 65, ctx, this.pkgUploadingEndTip)
        this.loadImage(circleX + 15, circleY / 6 + 18, ctx, this.pkgInstatiateEndTip)
        this.loadImage(circleX + 190, circleY + 63, ctx, this.pkgGetStatusEndTip)
      } else {
        this.loadImage(circleX / 3 - 25, circleY + 65, ctx, this.pkgUploadingEndTipEn)
        this.loadImage(circleX + 15, circleY / 6 + 18, ctx, this.pkgInstatiateEndTipEn)
        this.loadImage(circleX + 190, circleY + 63, ctx, this.pkgGetStatusEndTipEn)
      }
    },
      ...
      appstoreApi.getNodePort(this.appId, this.packageId, this.userId).then(
        (res) => {
          ...
          if (experienceInfo.message.indexOf('instantiate package failed.') !== -1) {
            this.showCanvas()
            this.clickOnlineBtn = false
            this.$message({
              duration: 2000,
              type: 'warning',
              message: this.$t('promptMessage.instantiateFailed')
            })
          } else if (experienceInfo.message.indexOf('not support multiple vms application experience') !== -1) {
            this.showCanvas()
            this.clickOnlineBtn = false
            this.$message({
              duration: 2000,
              type: 'warning',
              message: this.$t('promptMessage.notSupportVms')
            })
          ...
          } else if (experienceInfo.message.indexOf('get app url successfully.') !== -1) {
            this.switchBtn = false
            this.clickOnlineBtn = true
...
.appShowOnline {
  ...
  .btnClass{
    ...
    .batchProButtonTry:hover{
      color: #fff !important;
      background-color: #5F45BE !important;
    }
  }
  .div_title_tip{
    display: flex;
...
.el-table--border:after, .el-table--group:after, .el-table:before{
  background-color: 2px solid #4e3494;
}
div /deep/ .el-table th.is-leaf, .el-table td {
  color: #fff !important;
...
div /deep/ .el-table th.el-table_1_column_3, .el-table td {
