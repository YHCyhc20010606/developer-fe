...
let sandbox = {
  ...
  downloadExportImage: function (applicationId, vmId) {
    return URL_PREFIX_DEVELOPER + 'applications/' + applicationId + '/vms/' + vmId + '/action/download-image'
  },
  ...
  editCustom (flavorId, parmas) {
    return PUT(URL_PREFIX_DEVELOPER + 'flavors/' + flavorId, parmas)
  },
  deleteCustom (flavorId, userId) {
    return DELETE(URL_PREFIX_DEVELOPER + 'flavors/' + flavorId + '?userId=' + userId)
  },
  ...
  antiAffinityGroup: {
    addAntiAffinityGroup (applicationId, params) {
      return POST(URL_PREFIX_DEVELOPER + 'applications/' + applicationId + '/anti-affinity-groups', params)
    },
    updateAntiAffinityGroup (applicationId, antiaffinitygroupId, params) {
      return PUT(URL_PREFIX_DEVELOPER + 'applications/' + applicationId + '/anti-affinity-groups/' + antiaffinitygroupId, params)
    },
    deleteAntiAffinityGroup (applicationId, antiaffinitygroupId) {
      return DELETE(URL_PREFIX_DEVELOPER + 'applications/' + applicationId + '/anti-affinity-groups/' + antiaffinitygroupId)
    },
    getOneAntiAffinityGroup (applicationId, antiaffinitygroupId) {
      return GET(URL_PREFIX_DEVELOPER + 'applications/' + applicationId + '/anti-affinity-groups/' + antiaffinitygroupId)
    },
    getAntiAffinityGroup (applicationId, params) {
      return GET(URL_PREFIX_DEVELOPER + 'applications/' + applicationId + '/anti-affinity-groups', params)
    }
  }
...
let applicationApi = {
  ...
  deleteFileApi: function (fileId) {
    return DELETE(URL_PREFIX_DEVELOPER + 'upload-files/' + fileId)
  },
...
let imageMgmtService = {
  ...
  downloadVmImage: function (imageId) {
    return URL_PREFIX_DEVELOPER + 'vmimages/' + imageId + '/action/download-export-image'
  },
  // ContainerImage
...
let Capability = {
  ...
  getStandardCapabilities: function () {
    return GET(URL_PREFIX_DEVELOPER + 'query/capabilities/type/STANDARD')
  },
  getCapabilityGroupStats: function () {
    return GET(URL_PREFIX_DEVELOPER + 'query/capability-group-stats/type/OPENMEP')
  },
  getServiceListApi: function (groupId) {
    return GET(URL_PREFIX_DEVELOPER + 'capability-groups/' + groupId)
  },
  downloadSDKApi: function (fileId, lan) {
    return PROXY_PREFIX_CURRENTSERVER + '/mec-developer/mec/developer/v2/upload-files/' + fileId + '/action/download-sdk?lan=' + lan
  },
  getCapabilityById: function (id) {
    return GET(URL_PREFIX_DEVELOPER + 'capabilities/' + id)
  }
}
...
let applicationEditorApi = {
  getReleasedPackage: function (params) {
    return GET(URL_PREFIX_DEVELOPER + 'released-packages', params)
  },
  publishModifyApp: function (packageId, params) {
    return POST(URL_PREFIX_DEVELOPER + 'released-packages/' + packageId + '/action/release', params)
  },
  deleteModifyApp: function (packageId) {
    return DELETE(URL_PREFIX_DEVELOPER + 'released-packages/' + packageId)
  },
  getAppData: function (params) {
    return POST('mec-appstore/mec/appstore/v2/apps/action/query', params, 'appstore')
  },
  syncApplication: function (params) {
    return POST(URL_PREFIX_DEVELOPER + 'released-packages', params)
  },
  getPkgStucture: function (packageId) {
    return GET(URL_PREFIX_DEVELOPER + 'released-packages/' + packageId + '/action/get-pkg-structure')
  },
  getPkgContent: function (packageId, params) {
    return POST(URL_PREFIX_DEVELOPER + 'released-packages/' + packageId + '/action/get-file-content', params)
  },
  modifyPkgFile: function (packageId, params) {
    return PUT(URL_PREFIX_DEVELOPER + 'released-packages/' + packageId + '/action/edit-file-content', params)
  }
}

let meaoApi = {
  getThirdSystemsList: function () {
    return GET(URL_PREFIX_DEVELOPER + 'third-systems')
  }
}
